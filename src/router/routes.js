const routes = [
  ...
  },
  {
    ...
    children : [
      { path: '/planner-createnew-routes', component: () => import('pages/Planner_create_new_routes.vue') },
      { path: '/planner-vehicle-details', component: () => import('pages/Planner_vehicle_details.vue') },
      { path: '/planner-journey-stats', component: () => import('pages/Planner_journey_stats.vue') },
      { path: '/planner-route-traffic-analysis', component: () => import('pages/Planner_RouteTraffic_Analysis.vue') },
