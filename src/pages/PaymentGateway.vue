        ...
        <q-tab-panel name="upi">
          <q-card-section>
            ...
            <div class="row justify-around">
              <q-btn flat class="q-pa-none" @click="selectUPI('PhonePe')">
                <img
              ...
              <q-btn flat class="q-pa-none" @click="selectUPI('Google Pay')">
                <img
              ...
              <q-btn flat class="q-pa-none" @click="selectUPI('Paytm')">
                <img
                  src="https://thepatriot.in/wp-content/uploads/2024/02/Paytm.jpg"
                  alt="Paytm"
                  class="upi-logo"
                />
              </q-btn>
