      ...
      <div class="container">
        ...
        <q-form @submit.prevent="submitForm">
          <div>
            ...
            <q-input filled v-model.lazy.trim="name" id="name_input" placeholder="Enter your name" required />
          </div>
  
          <div>
            <label for="email_input">Email <span class="required">*</span></label>
            <q-input filled v-model="email" id="email_input" type="email" placeholder="Enter your email" required />
          </div>
          ...
          <div>
            ...
            <q-checkbox v-model="complaint" id="complaint" />
          </div>
          ...
          <div v-if="complaint">
            <div>
              ...
              <q-input filled v-model="busNo" id="bus_no_input" placeholder="Enter the bus route number" />
            </div>
            <div>
              <label for="journey_time_input">Time of Journey</label>
              <q-input filled v-model="journeyTime" id="journey_time_input" type="time" />
            </div>
            <div>
